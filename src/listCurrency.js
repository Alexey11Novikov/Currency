...
import { getLocalStorage, setLocalStorage, fetchConvers } from "./script.js";
...
const HTMLfunc = (arrayCurrency) => {
    ...
    arrayCurrency.forEach(elements => {
        ...
        <div class="grid">
            ...
            <button class="btnRound chg-curr _openModalBtn" data-modal=${elements[0]}>
            ...
            <label>${getLocalStorage("conversRates") ? JSON.parse(getLocalStorage("conversRates"))[elements[0]] : ""}</label>
        </div>
    </div>
